...
if ( ! function_exists( 'woocommerce_content' ) ) {
	...
	function woocommerce_content() {
		...
		<?php 
				$image = get_field('hero_image', 4);
				// echo "<pre>";
				// echo var_dump($image["sizes"]);
				// echo "</pre>"
				?>
			<div class="shop-page-header">
				...
				<picture>
					<source srcset="<?php echo $image["sizes"]["fp-large"] ?>" media="(min-width: 1024px)">
					<source srcset="<?php echo $image["sizes"]["fp-medium"] ?>" media="(min-width: 640px)">

					<img src="<?php echo $image["sizes"]["fp-small"]; ?>" alt="<?php echo $image["alt"]; ?>" />
				</picture>
				
				<div class="shop-page-header__text">
